...
FILE_NAMES = {
    "balance":       os.getenv("DRIVE_FILE_BALANCE",       "PP_Balance_de_activos.csv"),
    "rendimiento":   os.getenv("DRIVE_FILE_RENDIMIENTO",   "PP_Valores_y_rendimiento_Rendimiento_de_los_activos.csv"),
...
class DriveClient:
    ...
    def _find_file_id(self, name: str) -> Optional[str]:
        """Busca el file ID por nombre (primera coincidencia)."""
